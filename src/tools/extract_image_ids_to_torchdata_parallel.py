...
# python3 src/tools/extract_image_ids_to_torchdata_parallel.py --tokenizer configs/tokenizer/multimodal_llama_tokenizer.yaml --image_transform configs/processer/blip_transform.yaml --data configs/data/caption_torchdata_preprocess.yaml --save_dir dataset/seed_llama/caption/unsplash_cc3m/ --batch_size 1024 --num_workers 8 --gpus 8
