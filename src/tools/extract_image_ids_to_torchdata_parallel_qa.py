...
# python3 src/tools/extract_image_ids_to_torchdata_parallel_qa.py --tokenizer configs/tokenizer/multimodal_llama_tokenizer.yaml --image_transform configs/processer/blip_transform.yaml --data configs/data/question_answer_torchdata_eval.yaml --save_dir  data/VQAv2 --batch_size 512 --num_workers 8 --gpus 8
