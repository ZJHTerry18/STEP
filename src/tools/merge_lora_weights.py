...
# python3 src/tools/merge_lora_weights.py --model_cfg configs/model/vicuna_7b_lora_pretrained.yaml --tokenizer_cfg configs/tokenizer/multimodal_llama_tokenizer.yaml --base_model pretrained/vicuna-7b-v1.1 --lora_model log/seed_vicuna-7b_lora_pretrain/checkpoint-10000 --save_path log/seed_vicuna-7b_lora_pretrain/checkpoint-merged-10000
