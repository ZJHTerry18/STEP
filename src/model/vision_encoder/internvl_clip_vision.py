...
class InternVL_CLIP(nn.Module):
    ...
    def forward(self, image):
        ...
        # print(f"\033[31m 6b teacher x.dtype={x.dtype}\033[0m")
        B, T, HW, C = x.size()
...
def internvl_clip_6b(
    ...
    ckpt_path = "/mnt/petrelfs/share_data/wangwenhai/internvl/6b_vit_exp126_clip_alpaca_7b_laion5b_peak_1e-5_256gpu_all_trainable_degradation.sh/1499/mp_rank_00_model_states.pt"
    # ckpt_path = '/mnt/petrelfs/share_data/likunchang/model/internvl_clip/' \
    #             '6b_vit_exp126_clip_alpaca_7b_laion5b_peak_1e-5_256gpu_all_trainable_degradation.sh/' \
    #             '1499/mp_rank_00_model_states.pt'
    
    logger.info(f"Load internclip from: {ckpt_path}")
