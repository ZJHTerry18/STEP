...
class ImageCapEvalDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        try:
            ...
            unified_tokens = self.tokenizer.bos_token + self.role[0] + "Write a terse but informative summary of the following video clip." + "[INST]" + " " +"<Image>" + IMG_TOKEN + "</Image>" + " " + "[/INST]" + self.role[1]
...
class VideoCapEvalDataset(ImageCapEvalDataset):
    ...
    def __getitem__(self, index):
        try:
            ...
            unified_tokens = self.tokenizer.bos_token + "Describe the following video concisely." + "[INST]" + " " + "<Video>" + VID_TOKEN + "</Video>" + "[/INST]"
