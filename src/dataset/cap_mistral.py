...
class ImageCapEvalDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        try:
            ...
            unified_tokens = self.tokenizer.bos_token + self.role[0] + random.choice(self.prompt) + "[INST]" + " " +"<Image>" + IMG_TOKEN + "</Image>" + " " + "[/INST]" + self.role[1]
...
class VideoCapEvalDataset(ImageCapEvalDataset):
    ...
    def __getitem__(self, index):
        try:
            ...
            unified_tokens = self.tokenizer.bos_token + self.role[0] + "[INST]" + " " + "<Video>" + VID_TOKEN + "</Video>" + " Describe the following video concisely" + "[/INST]" + self.role[1]
