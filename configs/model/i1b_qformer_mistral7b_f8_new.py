...
model = dict(
    ...
    pretrained_paths=dict(
        pretrained_vit_qformer_path="/mnt/petrelfs/wangchenting/multimodalllm/logs/scripts/pt/1b_qformer_mistral/stage1.sh_20240613_194546/checkpoint-last.pth",
    ),
