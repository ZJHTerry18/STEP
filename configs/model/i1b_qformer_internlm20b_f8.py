...
custom_lr_wd_dict=dict(
    lm={'lr':4e-5, 'wd':None},
    vision_encoder={'lr':4e-5, 'wd':None}
)
...
model = dict(
    ...
    pretrained_paths=dict(
        pretrained_vit_qformer_path="/mnt/petrelfs/wangchenting/multimodalllm/logs/scripts/pt/1b_qformer_internlm20b/stage1_4f_prompt.sh_20240625_162843/checkpoint-last.pth",
    ),
