...
srun -p video5 \
    ...
    --pretrained_path /mnt/petrelfs/lixinhao/lxh_exp/multimodalllm-lxh/logs/scripts/pt/pt_umt-L_qformer_vicuna7b_f4_5m_smit.sh_20240501_013705/checkpoint-last/pytorch_model.bin \
