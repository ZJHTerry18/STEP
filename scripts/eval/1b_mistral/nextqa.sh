...
srun -p video5 \
    ...
    --gres=gpu:8 \
    --ntasks-per-node=8 \
    -w SH-IDCA1404-10-140-54-[12] \
    --cpus-per-task=16 \
    --kill-on-bad-exit=1 \
    python \
    -u src/train/train_or_eval.py \
    --is_eval True \
    --model configs/model/i1b_qformer_mistral7b_f4.py \
    ...
    --pretrained_path /mnt/petrelfs/wangchenting/multimodalllm/logs/scripts/pt/1b_qformer_mistral/stage2.sh_20240613_132147/checkpoint-5000/model.safetensors \
