...
JOB_NAME=$(basename $0)_glfgtc_hd_loss_vtc2.0
...
srun -p video5 \
    ...
    --model_path logs/scripts/pt/1b_qformer_mistral/ablation/stage1_16f_glfgtc_hd_loss.sh_glfgtc_loss_vtc2.0/checkpoint-last \
