...
srun -p video5 \
    ...
    --mode 'it_hd' \
    --model configs/model/i1b_qformer_internlm7b_f8_hd_full.py \
    --llm_path '/mnt/petrelfs/share/videointern/MLLM/internlm2_5_7b_1m' \
    --model_path '/mnt/petrelfs/wangchenting/checkpoint/internvideo2_1b_internlm7b_stage2_f4_converted_f8' \
