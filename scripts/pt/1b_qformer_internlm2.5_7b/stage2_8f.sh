...
srun -p video5 \
    ...
    --model_path '/mnt/petrelfs/wangchenting/checkpoint/internvideo2_1b_internlm7b_stage2_f4_converted_f8_lora' \
    --llm_path '/mnt/petrelfs/share/videointern/MLLM/internlm2_5_7b_1m' \
    --tokenizer configs/tokenizer/internlm7b_tokenizer_q96.yaml \
    --train_data configs/dataset/data_config/it_baseline_f8_origin.py \
