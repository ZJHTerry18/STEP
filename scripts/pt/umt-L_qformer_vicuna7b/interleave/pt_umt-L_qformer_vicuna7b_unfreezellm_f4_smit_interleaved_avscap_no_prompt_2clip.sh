...
srun -p video5 \
    ...
    --cpus-per-task=16 \
    --kill-on-bad-exit=1 \
    -x SH-IDCA1404-10-140-54-[41] \
    python -u src/train/train_or_eval.py \
    --model configs/model/umt-L_qformer_vicuna7b_f4_unfreeze_llm.py \
    ...
    --train_data configs/dataset/data_config/internvid2_interleaved_1M_avscap_smit_f4_no_prompt_2clips.py \
